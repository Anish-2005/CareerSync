  ...
  return (
    <section className="pt-32 md:pt-24 relative min-h-screen md:h-screen w-full flex items-center justify-center overflow-hidden py-24 md:py-0">
      ...
      >
        ...
        >
          <motion.span className="text-sm sm:text-base md:text-xl max-w-3xl mx-auto leading-relaxed font-light px-4"
            ...
            <m.div
              ...
              animate={{
                borderImage: theme.theme === 'light' ? [
                  "linear-gradient(45deg, #4f46e5, #f59e0b, #10b981, #4f46e5) 1",
                  "linear-gradient(135deg, #f59e0b, #10b981, #4f46e5, #f59e0b) 1",
                  "linear-gradient(225deg, #10b981, #4f46e5, #f59e0b, #10b981) 1",
                  "linear-gradient(45deg, #4f46e5, #f59e0b, #10b981, #4f46e5) 1",
                ] : [
                  "linear-gradient(45deg, #00d4ff, #ff6b00, #00ff88, #00d4ff) 1",
                  "linear-gradient(135deg, #ff6b00, #00ff88, #00d4ff, #ff6b00) 1",
                  "linear-gradient(225deg, #00ff88, #00d4ff, #ff6b00, #00ff88) 1",
                  "linear-gradient(45deg, #00d4ff, #ff6b00, #00ff88, #00d4ff) 1",
                ],
              }}
              transition={{
